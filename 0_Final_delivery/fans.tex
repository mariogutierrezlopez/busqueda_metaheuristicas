\section{FANS: Fuzzy Adaptative Neighborhood Search}

\subsection{Introducción}

Como explican los autores \cite{blanco2003fans}, FANS es un método de búsqueda por entornos adaptativo y difuso, basado en cuatro componentes principales:
\begin{itemize}
...
\subsubsection{Operador de Modificación}
El operador de modificación va a construir nuevas soluciones $s_i$ a partir de las soluciones anteriores $s$. Se define tal que $\mathcal{O}_i \in \mathcal{M}$, $\mathcal{O}_i : \mathcal{S} \times \mathcal{P} \rightarrow S$


\subsubsection{Valoración Difusa}
...
\subsubsection{Administrador de Operación}
...
\subsubsection{Administrador de Vecindario}
...
\subsubsection{Parámetros globales}
...
\subsection{FANS como Heurística de Propósito General}
