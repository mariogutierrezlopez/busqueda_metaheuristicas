...
La implementación del algoritmo de Optimización Basada en Biogeografía (BBO) para las funciones de prueba multiobjetivo se realizó en Python 3. Se utilizaron librerías como Numpy para cálculos numéricos vectorizados, Matplotlb.pyplot para generar las gráficas de los frentes de Pareto, random para funciones de aleatoriedad y copy para asegurar la creación de copias independientes de las soluciones candidatas.
